 ...
 */
export declare const getAnimationDuration: () => number;

/**
 * Get the current animation frame rate.
 * @group Global Settings
 */
export declare const getAnimationFPS: () => number;

/**
 * Get the current animation repeat mode.
 * @group Global Settings
 */
export declare const getAnimationMode: () => AnimationMode;
 ...
 * @group Global Settings
 */
export declare const getCircularSegments: (radius: number) => number | undefined;
 ...
 * @group Global Settings
 */
export declare const getMinCircularAngle: () => number;
 ...
 * @group Global Settings
 */
export declare const getMinCircularEdgeLength: () => number;
